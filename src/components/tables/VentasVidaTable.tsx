...
interface VentasVidaTableProps {
  data: VentaVida[];
  isLoading?: boolean;
  onEdit?: (item: VentaVida) => void;
  onDelete?: (id: string) => void;
}

const calcDias = (item: VentaVida): number => {
...
export const VentasVidaTable = ({
  data,
  isLoading,
  onEdit,
  onDelete,
}: VentasVidaTableProps) => {
  const pageSize = 10;
  ...
  const columns: Column<VentaVida>[] = [
    {
      header: "Fecha",
      cell: (item) => {
